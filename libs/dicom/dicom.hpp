...
namespace VVV
{
    ...
    public:
        struct ParseError : public std::runtime_error
        {
            ...
            explicit ParseError(const char *c) : std::runtime_error(c) {}
        };

        struct StreamError : public ParseError
        {
            explicit StreamError(const std::string &s) : ParseError(s) {}
            explicit StreamError(const char *c) : ParseError(c) {}
        };

        struct MissingTagError : public ParseError
        {
            explicit MissingTagError(const std::string &s) : ParseError(s) {}
            explicit MissingTagError(const char *c) : ParseError(c) {}
        };
		...
		union TypeTag {
            ...
            char raw[4];
			TypeTag() {}
			explicit TypeTag(const uint32_t v) : number(v) {}
			explicit TypeTag(const uint16_t v1, const uint16_t v2) { id[0] = v1; id[1] = v2; }
        };
		...
		union TypeVR {
            ...
            char raw[2];
			TypeVR() {}
			explicit TypeVR(const uint16_t v) : number(v) {}
        };
		...
		public:
            ...
            Element(Dicom *parent) : _parent(parent) {}
            ...
            /// @return Element tag
            inline TypeTag tag() const { return this->_tag; }

            /// reader accessor: VR
            /// @return Element VR
			inline TypeVR vr() const { return this->_vr; }

            /// value is a vector or not
            /// @return value is a vector: true || false
            inline bool is_vector() const { return this->_is_vector; }

            /// value is empty or not
            /// @return true if value is empty; false
            inline bool empty() const { return this->_value.empty(); }

            /// type_info of value
            /// @return type_info of value
            inline const std::type_info &type() const { return this->_value.type(); }

            /// reader accessor: element value
            /// @return any type of element value
            inline boost::any value() const { return this->_value; }

            /// reader accessor: element value
            /// @return specify class of element value
            /// throw boost::bad_any_cast
            template <class T> T as() const { return boost::any_cast<T>(this->_value); }
            ...
            TypeTag parse_tag(std::istream &ist)
            {
                ...
                if (ist.eof() || !ist.good()) throw StreamError("");
        ...
        private:
            ...
            Element &_read_element_data_string(std::istream &ist, const size_t len);
    ...
    public:
		static const uint16_t TAG_GROUP_META;//=0x0002;
		static const uint16_t TAG_GROUP_DIRECTORY;//=0x0004;

		static const TypeTag TAG_TRANSFER_SYNTAX_UID;//={{0x0002,0x0010}};
		static const TypeTag TAG_IMG_POSITION;//={{0x0020,0x0032}};
		static const TypeTag TAG_PHOTO_INTERPRET;//={{0x0028,0x0004}};
		static const TypeTag TAG_ROWS;//={{0x0028,0x0010}};
		static const TypeTag TAG_COLS;//={{0x0028,0x0011}};
		static const TypeTag TAG_PX_SPACING;//={{0x0028,0x0030}};
		static const TypeTag TAG_BIT_ALLOC;//={{0x0028,0x0100}};
		static const TypeTag TAG_BIT_STORED;//={{0x0028,0x0101}};
		static const TypeTag TAG_HI_BIT;//={{0x0028,0x0102}};
		static const TypeTag TAG_PX_REP;//={{0x0028,0x0103}};
		static const TypeTag TAG_RESCALE_INT;//={{0x0028,0x1052}};
		static const TypeTag TAG_RESCALE_SLP;//={{0x0028,0x1053}};
		static const TypeTag TAG_FRAME_DATA;//={{0x7fe0,0x0010}};
...
// Element tags
//
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_TRANSFER_SYNTAX_UID;//= VVV::Dicom::TypeTag(0x0002, 0x0010),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_IMG_POSITION;//= VVV::Dicom::TypeTag(0x0020, 0x0032),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_PHOTO_INTERPRET;//= VVV::Dicom::TypeTag(0x0028, 0x0004),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_ROWS;//= VVV::Dicom::TypeTag(0x0028, 0x0010),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_COLS;//= VVV::Dicom::TypeTag(0x0028, 0x0011),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_PX_SPACING;//= VVV::Dicom::TypeTag(0x0028, 0x0030),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_BIT_ALLOC;//= VVV::Dicom::TypeTag(0x0028, 0x0100),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_BIT_STORED;//= VVV::Dicom::TypeTag(0x0028, 0x0101),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_HI_BIT;//= VVV::Dicom::TypeTag(0x0028, 0x0102),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_PX_REP;//= VVV::Dicom::TypeTag(0x0028, 0x0103),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_RESCALE_INT;//= VVV::Dicom::TypeTag(0x0028, 0x1052),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_RESCALE_SLP;//= VVV::Dicom::TypeTag(0x0028, 0x1053),
//	static const VVV::Dicom::TypeTag VVV::Dicom::TAG_FRAME_DATA;//= VVV::Dicom::TypeTag(0x7fe0, 0x0010);
//
//
////////////////////////////////////////////////////////////////////////
